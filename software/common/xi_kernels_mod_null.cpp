...
// NOTE: Passing NULL values to arguments causes cosim to fail
...
*/
	...
	DnnWrapper( 
        ...
        NULL, NULL,
				...
				NULL,
#endif
				0, // This int is set has 0 for some reason when convolution is not happening, even though other ints in other layers are set as NULL
#endif //CONV kernel
#if __POOL_ENABLE__==1
...
*/
	...
	DnnWrapper( 
        ...
        NULL, NULL,
				...
				NULL,
#endif
				NULL, // This int is set has 0 for some reason when convolution is not happening, even though other ints in other layers are set as NULL
#endif //CONV kernel
#if __POOL_ENABLE__==1
        NULL, NULL,
				NULL, NULL,
