...
int dataproc_chai(char* dirpath, char* prototxt, char* caffemodel, unsigned int* img_path1, unsigned int* img_path2, float* final_results) {
    ...
    // char *dirpath    = "/home/yd383/CHaiDNN/tools/xilinx_quant_example_model/GoogleNetWithoutLRN"; /* Path to the network model directory */
    // char *prototxt   = "quantized_GoogleNetNoLRN_deploy_CHaiDNN.prototxt";       /* Prototxt file name residing in network model directory */
    // char *caffemodel = "GoogleNetNoLRN.caffemodel";  /* caffemodel file name residing in network model directory */
    
    // char *img_path1  = "/home/yd383/CHaiDNN/SD_Card/images/camel.jpg";
    // char *img_path2  = "/home/yd383/CHaiDNN/SD_Card/images/camel.jpg";
    ...
    int inp_mode = 3; // 3 for cast encoded image to CHaiDNN
