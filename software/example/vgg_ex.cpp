...
int main(int argc, char **arcv) {
    ...
    char *dirpath    = "/home/mpa46/CHaiDNN/software/example/VGG-16/6Bit"; /* Path to the network model directory */
    char *prototxt   = "VGG16_6Bit_deploy_CHaiDNN.prototxt";       /* Prototxt file name residing in network model directory */
    char *caffemodel = "VGG16_6Bit_CHaiDNN.caffemodel";  /* caffemodel file name residing in network model directory */
