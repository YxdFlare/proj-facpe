...
int main(int argc, char **arcv) {
    ...
    char *dirpath    = (char*)"/home/isn7/CHaiDNN-Dev/software/example"; /* Path to the network model directory. Update username locally */
    char *prototxt   = (char*)"lenet.prototxt";       /* Prototxt file name residing in network model directory */
    char *caffemodel = (char*)"lenet.caffemodel";  /* caffemodel file name residing in network model directory */

    // NOTE: LeNet uses MNIST 28x28 images
    char *img_path1  = (char*)"/home/isn7/CHaiDNN-Dev/software/example/image_1.jpg"; /* Update username and image locally */
    char *img_path2  = (char*)"/home/isn7/CHaiDNN-Dev/software/example/image_1.jpg"; /* Update username and image locally */
    ...
    *mean_ptr = 0;
    ...
    for (int batch_id = 0; batch_id < numImg_to_process; batch_id++) {
	  void *ptr = (int8_t *)malloc(3*resize_h*resize_w*sizeof(int8_t));
